...
(function dartProgram() {
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              // Function start
              $async$goto = 2;
              return A._asyncAwait(A.get(A.Uri_parse("https://pokeapi.co/api/v2/pokemon/ditto")), $async$main);
            case 2:
              // returning from await.
              response = $async$result;
              if (response.statusCode === 200) {
                data = B.C_JsonCodec.decode$2$reviver(0, A.encodingForCharset(A._contentTypeForHeaders(response.headers).parameters._map.$index(0, "charset")).decode$1(0, response.bodyBytes), null);
                t1 = document.querySelector("#output");
                t1.toString;
                J.set$text$x(t1, "T\xedtulo: " + A.S(J.$index$asx(data, "name")));
              } else {
                t1 = document.querySelector("#output");
                t1.toString;
                J.set$text$x(t1, "Erro ao carregar dados");
              }
              // implicit return
  ...
  (function installTearOffs() {
    ...
    _instance(A._Completer.prototype, "get$completeError", 0, 1, null, ["call$2", "call$1"], ["completeError$2", "completeError$1"], 46, 0, 0);
  ...
  (function inheritance() {
    ...
    _inheritMany(A.Stream, [A.StreamView, A._StreamImpl, A._EmptyStream]);
