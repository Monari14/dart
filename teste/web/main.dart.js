...
(function dartProgram() {
  ...
  A.main_closure.prototype = {
    call$1($event) {
      ...
      $name = t2._as(t1.querySelector("#name")).value;
      if ($name == null)
        $name = "";
      age = t2._as(t1.querySelector("#age")).value;
      if (age == null)
        age = "";
      if ($name.length !== 0 && age.length !== 0) {
        t1 = t1.querySelector(_s9_);
        if (t1 != null)
          J.set$text$x(t1, "Ol\xe1, " + $name + "! Voc\xea tem " + age + " anos.");
      } else {
        t1 = t1.querySelector(_s9_);
        if (t1 != null)
          J.set$text$x(t1, "Por favor, preencha todos os campos.");
      }
    },
    $signature: 10
  };
